...
- [A. Enumeration Principles \& Methodology](#a-enumeration-principles-methodology)
- [B.1. Infrastructe Based Enumeration: Domain Information](#b1-infrastructe-based-enumeration-domain-information)
  - [Certificate Transparency](#certificate-transparency)
  - [Company Hosted Servers](#company-hosted-servers)
  - [DNS Records](#dns-records)
- [B.2. Infrastructure Based Enumeration: Cloud Resources](#b2-infrastructure-based-enumeration-cloud-resources)
...
- [C.1. Host Based Enumeration: FTP](#c1-host-based-enumeration-ftp)
  - [TFTP](#tftp)
...
- [C.2. Host Based Enumeration: SMB](#c2-host-based-enumeration-smb)
  - [Default Configuration](#default-configuration-1)
  - [Dangerous Settings](#dangerous-settings-1)
  - [SMB Commands](#smb-commands)
    - [Listing Shares \& Connecting to the Share](#listing-shares-connecting-to-the-share)
    - [Downloading Files from SMB](#downloading-files-from-smb)
...
- [C.3. Host Based Enumeration: NFS](#c3-host-based-enumeration-nfs)
  ...
  - [Privilege Escalation with NFS](#privilege-escalation-with-nfs)
- [C.4. Host Based Enumeration: DNS](#c4-host-based-enumeration-dns)
  ...
  - [Default Configuration](#default-configuration-3)
    ...
    - [Reverse Name Resolution Zone Files](#reverse-name-resolution-zone-files)
  ...
  - [Footprinting the Service](#footprinting-the-service-3)
    ...
    - [Zone Transfers Theory](#zone-transfers-theory)
    - [DIG - AXFR Zone Transfer](#dig---axfr-zone-transfer)
    - [DIG - AXFR Zone Transfer - Internal](#dig---axfr-zone-transfer---internal)
    - [Subdomain Brute Forcing](#subdomain-brute-forcing)
- [C.5. Host Based Enumeration: SMTP](#c5-host-based-enumeration-smtp)
  - [Default Configuration](#default-configuration-4)
  - [Interaction with a SMTP server](#interaction-with-a-smtp-server)
...
- [C.6. Host Based Enumeration: IMAP/POP3](#c6-host-based-enumeration-imappop3)
...
- [C.7. Host Based Enumeration: SNMP](#c7-host-based-enumeration-snmp)
  - [SNMP Set up](#snmp-set-up)
    - [MIB](#mib)
    - [OID](#oid)
  ...
  - [Footprinting the Service](#footprinting-the-service-6)
    ...
    - [Braa](#braa)
- [C.8. Host Based Enumeration: MySQL](#c8-host-based-enumeration-mysql)
  - [MySQL Clients](#mysql-clients)
  - [MySQL Databases](#mysql-databases)
  - [Default Configurations](#default-configurations)
  - [Dangerous Settings](#dangerous-settings-7)
  - [Footprinting the Service](#footprinting-the-service-7)
    - [Nmap](#nmap-4)
    - [Interaction with MySQL Server](#interaction-with-mysql-server)
    - [MySQL Commands to remember](#mysql-commands-to-remember)
- [C.9. Host Based Enumeration: MSSQL](#c9-host-based-enumeration-mssql)
  - [Default Configuration](#default-configuration-7)
  - [Dangerous Settings](#dangerous-settings-8)
  - [Footprinting the Service](#footprinting-the-service-8)
    - [Nmap](#nmap-5)
    - [MSSQL Ping in Metasploit](#mssql-ping-in-metasploit)
    - [Connecting with Mssqlclient.py](#connecting-with-mssqlclientpy)
- [C.10. Host Based Enumeration: Oracle TNS](#c10-host-based-enumeration-oracle-tns)
  - [Default Configuration](#default-configuration-8)
    - [Tnsnames.ora](#tnsnamesora)
    - [Listener.ora](#listenerora)
    - [SID](#sid)
  - [Footprinting the Service](#footprinting-the-service-9)
    - [ODAT](#odat)
    - [Nmap](#nmap-6)
    - [Nmap - SID Bruteforcing](#nmap---sid-bruteforcing)
    - [SQLPlus](#sqlplus)
- [C.11. Host Based Enumeration: IPMI](#c11-host-based-enumeration-ipmi)
  - [Footprinting the Service](#footprinting-the-service-10)
    - [Nmap](#nmap-7)
    - [Metasploit Version Scan](#metasploit-version-scan)
    - [Default Passwords](#default-passwords)
  - [Dangerous Settings](#dangerous-settings-9)
- [D. Linux Remote Management Protocols](#d-linux-remote-management-protocols)
  - [SSH](#ssh)
    - [Default Configuration](#default-configuration-9)
    - [Dangerous Settings](#dangerous-settings-10)
  - [Footprinting the Service](#footprinting-the-service-11)
    - [SSH-Audit](#ssh-audit)
    - [Change Authentication Method](#change-authentication-method)
  - [Rsync](#rsync)
  - [R-Services](#r-services)
    - [/etc/hosts.equiv File](#etchostsequiv-file)
    - [.rhosts File](#rhosts-file)
    - [Scanning for R-services with Nmap](#scanning-for-r-services-with-nmap)
...
- [E. Windows Remote Management Protocol](#e-windows-remote-management-protocol)
  - [RDP](#rdp)
    - [Footprinting the Service](#footprinting-the-service-12)
      - [Nmap](#nmap-8)
      - [RDP Security Check](#rdp-security-check)
      - [Initiate an RDP Session](#initiate-an-rdp-session)
  - [WinRM](#winrm)
    - [Footprinting the Service](#footprinting-the-service-13)
      - [Nmap](#nmap-9)
      - [Evil-winrm](#evil-winrm)
  - [WMI](#wmi)
    - [Footprinting the Service](#footprinting-the-service-14)
      - [WMIexec.py](#wmiexecpy)
- [F. Footprinting Lab - Easy](#f-footprinting-lab---easy)
  - [Nmap Scan](#nmap-scan)
  - [Interacting with the FTP server](#interacting-with-the-ftp-server)
  - [Interacting with SSH](#interacting-with-ssh)
- [G. Footprinting Lab - Medium](#g-footprinting-lab---medium)
  - [Nmap Scan](#nmap-scan-1)
  - [Exploring NFS](#exploring-nfs)
  - [Exploring SMB](#exploring-smb)
  - [Exploring RDP](#exploring-rdp)
- [H. Footprinting Lab - Hard](#h-footprinting-lab---hard)
  - [Nmap Scan](#nmap-scan-2)
  - [Exploring SNMP](#exploring-snmp)
  - [Exploring IMAP/POP3](#exploring-imappop3)
  - [Exploring SSH](#exploring-ssh)
  - [Exploring MySQL](#exploring-mysql)
